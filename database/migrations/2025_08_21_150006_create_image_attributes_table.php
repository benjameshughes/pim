...
{
    /**
     * Create image_attributes table for image-specific attribute values
     */
    public function up(): void
    {
        Schema::create('image_attributes', function (Blueprint $table) {
            ...
            // Unique constraint - one value per image per attribute
            $table->unique(['image_id', 'attribute_definition_id']);
